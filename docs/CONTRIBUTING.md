# Contributing to LeetABit.Binary project

## Prerequisites

By contributing to LeetABit.Binary project, you assert that:

* The contribution is your own original work.
* You have the right to assign the copyright for the work (it is not owned by your employer, or
  you have been given copyright assignment in writing).
* You [license](../LICENSE) the contribution under the terms applied to the rest of the LeetABit.Binary project.
* You agree to follow the [code of conduct](CODE_OF_CONDUCT.md).

## How to contribute

First of all, thank you for your interest in contributing to LeetABit.Binary! This document explains what you need to know to get started.
...
* Specify version of the LeetABit.Binary the issue applies to.
